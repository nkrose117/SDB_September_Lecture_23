...
/* 
        ...
        - Using a forEach loop, loop through the presidents have it console.log () first name, last name was XX years old when they died.
...
// Alive Presidents List
// presidents.forEach(({first, last, passed}) => {
//     if(passed <= 2018){
//         console.log(first,last);
//     }
// });

// Dead Presidents List
// presidents.forEach(({first, last, passed}) => {
//     if(passed === undefined){
//         console.log(first,last);
//     }
...
// Dead President Sentence, Year of Death
presidents.forEach((presidents) => {
    let sentence = ` Hi, Im ${presidents.first} ${presidents.last} I died in ${presidents.passed}`;
    if(presidents.passed <= 2018){
...
// Dead Pres Sentence 1
// presidents.forEach((presidents) => {
//     let sentence = ` Hi, Im ${presidents.last} I died in ${presidents.passed}`;
//     console.log(sentence);
// }
// );

// other thing
// presidents.forEach((presidents, index) => {
//     let sentence = `${index} Hi, I died in ${presidents.passed}`;
//     console.log(sentence);
// }
// );
...
presidents.forEach(function(first, last) {
...
const filteredPres = presidents.filter(pres, passed) { // this will run through each position in the array
    console.log('Parameter:', pres)
    let result = pres,{passed} !== undefined; // store anything that isn't 'mango'
...
presidents.forEach(first, passed); {
    if(passed = true) {
        console.log(first)
    }; 
}
...
// check class GPA replit HW assignment (lab?)
